"""Test if the new system is deterministic."""
import requests
...
if all_match:
    ...
    print("  -> Rule depends on MORE than just neighbor count")
    print("  -> Could be: specific neighbor pattern, position, or other state")
else:
    print("\nCONCLUSION: System is STOCHASTIC")
